...
cfg = {
    'model_arch': 'swsl_resnext50_32x4d',
    'img_size': 512,
    'batch_size': 128*2*2,
    'device_num': 8
}
...
rets = []
for model_name in glob.glob(f'checkpoint/seti-{cfg["model_arch"]}-fold[0-5]-512-auc.pth'):
...
test_df.to_csv(f'subs/submission_{cfg["model_arch"]}.csv', index=False)
